...
import { SysDictDataModel } from "./data";
...
const { handleEdit, handleAdd } = useSimpleList<SysDictDataModel>(url) as SimpleListType;

const visible = ref(false);
const ruleFormRef = ref<FormInstance>();
const title = ref("");
const { gtMd } = useScreenPixel();
const model = ref<Partial<SysDictDataModel>>({});
...
function edit(record: SysDictDataModel) {
  ...
  return [
    {
      ...
      rules: [
        {
          required: true,
          message: t("page.common.system.dict.package.column.name_placeholder"),
          trigger: "blur"
        }
      ],
      props: {
    ...
    },
    {
      ...
      rules: [
        {
          required: true,
          message: t("page.common.system.dict.package.column.description_placeholder"),
          trigger: "blur"
        }
      ],
      props: {
        maxLength: 50,
        placeholder: t("page.common.system.dict.package.column.description_placeholder")
      }
    },
    {
      name: "tenantId",
      ...
      rules: [
        {
          required: true,
          message: t("page.common.system.dict.package.column.tenantId_placeholder"),
          trigger: "blur"
        }
      ],
      props: {
